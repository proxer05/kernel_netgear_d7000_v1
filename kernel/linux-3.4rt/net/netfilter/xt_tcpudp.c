...
#ifdef _SC_BUILD_
bool (*sc_ipv6_tcp_frag_mt_hook)(const struct sk_buff **pskb, struct xt_action_param **ppar, struct xt_action_param *new_par);
EXPORT_SYMBOL(sc_ipv6_tcp_frag_mt_hook);
bool (*sc_ipv6_udp_frag_mt_hook)(const struct sk_buff **pskb, struct xt_action_param **ppar, struct xt_action_param *new_par);
EXPORT_SYMBOL(sc_ipv6_udp_frag_mt_hook);
#endif
...
{
#ifdef _SC_BUILD_
    struct xt_action_param new_par;
#endif
...
#ifdef _SC_BUILD_
    if (par->family == NFPROTO_IPV6 && sc_ipv6_tcp_frag_mt_hook) {
        sc_ipv6_tcp_frag_mt_hook(&skb, &par, &new_par);
    }
#endif
...
#ifdef _SC_BUILD_
    if (par->family == NFPROTO_IPV6 && sc_ipv6_udp_frag_mt_hook) {
        sc_ipv6_udp_frag_mt_hook(&skb, &par, &new_par);
    }
#endif
