...
#ifdef _SC_BUILD_
    kLedStateRedFastBlinkContinues,      /* red led fast blink continues at 4HZ interval */
	kLedStateRedSlowBlinkContinues,      /* red led slow blink continues at 2HZ interval */
	kLedStateDSLFail
#endif
} BOARD_LED_STATE;
