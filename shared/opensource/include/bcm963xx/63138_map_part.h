...
#define BT_UART_PHYS_BASE     0xfffec400
...
#define BT_UART_BASE     BCM_IO_ADDR(BT_UART_PHYS_BASE)  
...
#define BT_UART_TXFIFOFULL    (1 << 0) /* tx full          */                                  
#define BT_UART_TXFIFOAEMPTY  (1 << 1) /* tx almost empty  */                                  
#define BT_UART_RXFIFOAFULL   (1 << 2) /* rx almost full   */                                  
#define BT_UART_RXFIFOEMPTY   (1 << 3) /* rx empty         */                                  
#define BT_UART_RXFIFORES     (1 << 4) /* rx residue       */                                  
#define BT_UART_RXPARITYERR   (1 << 5) /* rx parity error  */                                   
#define BT_UART_RXBRKDET      (1 << 6) /* rx uart break    */                                  
#define BT_UART_RXCTS         (1 << 7) /* uart cts         */                                  
#define BT_UART_INT_MASK (0xff)                         
#define BT_UART_INT_MASK_DISABLE (0x00000000)           
...
#define BT_UART_DHBR_3000K    0x00000001 /* Target is 16 clocks/baud(bit), Based on 50Mhz Uart clk */
#define BT_UART_DLBR_3000K    0x000000ff /* Target is 16 clocks/baud(bit), Based on 50Mhz Uart clk */
#define BT_UART_DHBR_115200   0x00000011 /* Target is 16 clocks/baud(bit), Based on 50Mhz Uart clk */
#define BT_UART_DLBR_115200   0x000000e5 /* Target is 16 clocks/baud(bit), Based on 50Mhz Uart clk */
             
   uint32   ab0;          /* 0x588 ab0 Register                                */           
   uint32   unused4;      /* 0x588 - 0x58f                                     */
   uint32   FCR;          /* 0x590 FCR Register                                */           
#define BT_UART_FCR_AUTOLOAD_MODE (1 << 8)
#define BT_UART_FCR_AB_MODE       (1 << 7)
#define BT_UART_FCR_AUTO_RTS_OE   (1 << 6)
#define BT_UART_FCR_AUTO_TX_OE    (1 << 5)
#define BT_UART_FCR_AUTOBAUD      (1 << 4)
#define BT_UART_FCR_TX_PACKET     (1 << 3)
#define BT_UART_FCR_SLIP_RESYNC   (1 << 2)
   
   uint32   ab1;          /* 0x594 ab1 Register                                */           
   uint32   unused5;      /* 0x598 - 0x59f                                     */
   uint32   LCR;          /* 0x59c LCR Register                                */           
#define BT_UART_LCR_SLIP_TX_CRC       (1 << 11) 
#define BT_UART_LCR_SLIP_CRC_LSBFIRST (1 << 10) 
#define BT_UART_LCR_SLIP_CRC_INV      (1 << 9) 
#define BT_UART_LCR_SLIP_RX_CRC       (1 << 8) 
#define BT_UART_LCR_SLIP              (1 << 7) 
#define BT_UART_LCR_RTSOEN            (1 << 6) 
#define BT_UART_LCR_TXOEN             (1 << 5) 
#define BT_UART_LCR_LBC               (1 << 4) 
#define BT_UART_LCR_RXEN              (1 << 3) 
#define BT_UART_LCR_EPS               (1 << 2) 
#define BT_UART_LCR_PEN               (1 << 1) 
#define BT_UART_LCR_STB               (1 << 0)
    
   uint32   MCR;          /* 0x5a0 MCR Register                                */    
#define BT_UART_MCR_REPEAT_XON_XOFF (1 << 9)
#define BT_UART_MCR_PACKET_FLOW     (1 << 8)
#define BT_UART_MCR_BAUD_ADJ_EN     (1 << 7)
#define BT_UART_MCR_AUTO_TX_DISABLE (1 << 6)
#define BT_UART_MCR_AUTO_RTS        (1 << 5)
#define BT_UART_MCR_LOOPBACK        (1 << 4)
#define BT_UART_MCR_HIGH_RATE       (1 << 3)
#define BT_UART_MCR_XON_XOff_EN     (1 << 2)
#define BT_UART_MCR_PROG_RTS        (1 << 1)
#define BT_UART_MCR_TX_ENABLE       (1 << 0)
          
   uint32   LSR;          /* 0x5a4 LSR Register                                */   
#define BT_UART_LSR_TX_HALT        (1 << 5)    
#define BT_UART_LSR_TX_PACKET_RDY  (1 << 4)    
#define BT_UART_LSR_TX_IDLE        (1 << 3)    
#define BT_UART_LSR_TX_DATA_AVAIL  (1 << 2) /* 1 - Data in TX FIFO, 0 - TX FIFO empty */
#define BT_UART_LSR_RX_FULL        (1 << 1) /* 1 - RX FIFO full */     
#define BT_UART_LSR_RX_OVERFLOW    (1 << 0) /* 1 - RX FIFO Overflow */       
          
   uint32   MSR;          /* 0x5a8 MSR Register                                */         
#define BT_UART_MSR_RX_IN     (1 << 2)
#define BT_UART_MSR_RTS_STAT  (1 << 1)
#define BT_UART_MSR_CTS_STAT  (1 << 0)
...
#define BT_UART_RFC_1039BYTES_FC_DATA (1039)
#define BT_UART_RFC_NO_FC_DATA (BT_UART_RFC_1039BYTES_FC_DATA) // or should be LLI_BUFF_SIZE
            
   uint32   ESC;          /* 0x5b8 Escape Character Register                   */           
#define BT_UART_ESC_SLIP_DATA (0xDB)
#define BT_UART_ESC_NO_SLIP_DATA (0xDA)
...
#define BT_UART_DMA_CTL_BURSTMODE_EN   (1 << 3)
#define BT_UART_DMA_CTL_AFMODE_EN      (1 << 2)
#define BT_UART_DMA_CTL_FASTMODE_EN    (1 << 1)
#define BT_UART_DMA_CTL_DMA_EN         (1 << 0)
#define BT_UART_HO_BSIZE_DATA (0x3)
#define BT_UART_HI_BSIZE_DATA (0x3)
              
} BtUartCtrlRegs;

#define BT_UART ((volatile BtUartCtrlRegs * const) BT_UART_BASE)
...
#define PL081_DMA_CHAN_BT_UART_TX   "DMA_TO_BT_UART_TX"
#define PL081_DMA_CHAN_BT_UART_RX   "DMA_FROM_BT_UART_RX"
